               ...
               <footer className="footer footer-center p-10 bg-primary text-primary-content">
                    <div>
                         ...
                         <p className="font-bold">
                              Thanks for visiting the website for all the information
                         </p>
                         <p>Copyright © 2022 - mdmaruf5511507@gmail.com</p>
                    </div>
                    <div>
                         <div className="grid grid-flow-col gap-4">
                              ...
                              <a href='https://www.linkedin.com/in/maruf-bellah-ba82ba240/' target='_blank'>
                                   <img className='w-10 h-10' src={linkedin} alt="" />
                              </a>

                              {/*   <a><svg xmlns="http://https://www.facebook.com/profile.php?id=100075696977626" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a> */}
                              <a href='https://www.facebook.com/profile.php?id=100075696977626' target='_blank'>
                                   <img className='w-10 h-10' src={fd} alt="" />
                              </a>
                         </div>
                    </div>
               </footer>
